...
echo "sudo killall wpa_applicant" >> ~/scripts/start-wifi-std.sh
echo "sudo wpa_supplicant -B -i $inter -c /etc/wpa_supplicant/wpa_supp-std.conf" >> ~/scripts/start-wifi-std.sh
